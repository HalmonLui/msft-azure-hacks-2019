<template>
  <div class="policy">
    <h2>Welcome to Finance Boi</h2>
    <p>
      These terms and conditions outline the rules and regulations for the use
      of Finance Boi's Website.
    </p>
    <br />
    <span style="text-transform: capitalize;"> Finance Boi</span> is located
    at:<br />
    <address>Boston, MA<br /></address>
    <p>
      By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use Finance Boi's website if you do not accept
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Finance Boi's website you consent
      to the use of cookies in accordance with Finance Boi's privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Finance Boi and/or it's licensors own the
      intellectual property rights for all material on Finance Boi. All
      intellectual property rights are reserved. You may view and/or print pages
      from http://www.financeboi.com for your own personal use subject to
      restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from http://www.financeboi.com</li>
      <li>Sell, rent or sub-license material from http://www.financeboi.com</li>
      <li>
        Reproduce, duplicate or copy material from http://www.financeboi.com
      </li>
    </ol>
    <p>
      Redistribute content from Finance Boi (unless content is specifically made
      for redistribution).
    </p>
    ...
    <p>
      ...
      <?=$companyName?>; and (d) where the link is in the context of general
    ...
    <p>
      ...
      e-mail to
      <a href="mailto:luih@wit.edu" title="send an email to luih@wit.edu"
        >luih@wit.edu</a
    ...
    <p>
      No use of Finance Boi's logo or other artwork will be allowed for linking
